...
proximo.addEventListener('click',()=>{
     ...
     if(controle == 2){
        ...
        imagem.src = 'img/t(2).png';
  
     }
     if(controle == 3){
        texto.innerHTML = ' 3º Passo: Clique em " Quero começar um Podcast".';
        imagem.src = 'img/t(3).png';
     
     }
     if(controle == 4){
        texto.innerHTML = '4º Passo: Faça login com sua conta de e-mail..';
        imagem.src = 'img/t(4).png';
     }
     if(controle == 5){
        texto.innerHTML = '5º Passo: Aqui é onde a mágica acontece .Você pode criar seu podcast diretamente na plataforma ou apenas editá-lo. Clique em "Novo Episódio".';
        imagem.src = 'img/t(5).png';
     }
     if(controle == 6){
